...
(1, '章汶霖', 'Peter', 'Chang', 'male', 'peter777200067@gmail.com', 127, 4, '1997-07-04', 1, '2023-02-24 08:02:53');
...
--
ALTER TABLE `document_file`
  MODIFY `document_file_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `document_file_record`
--
ALTER TABLE `document_file_record`
  MODIFY `document_file_record_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `qac_document_file`
  MODIFY `qac_document_file_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `qac_document_file_record`
--
ALTER TABLE `qac_document_file_record`
  MODIFY `qac_document_file_record_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `staff_document_type_document_state`
--
ALTER TABLE `staff_document_type_document_state`
  MODIFY `staff_document_type_document_state_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `staff_list`
--
ALTER TABLE `staff_list`
  MODIFY `staff_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `staff_list_department`
--
ALTER TABLE `staff_list_department`
  MODIFY `staff_list_department_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `staff_owner_company`
--
ALTER TABLE `staff_owner_company`
  MODIFY `staff_owner_company_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
